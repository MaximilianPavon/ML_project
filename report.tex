...
\begin{abstract}
In this project we explore different methods to tackle a simple Machine Learning problem. We present different methods to model a music genre classification based on song features and discuss the implications that skewed classes have on the training process. After that we show the results and conclude that simple modelling is not sufficient enough and, albeit complicated, there are still opportunities for further enhancements regarding performance.
...
\begin{figure}[h]
	...
	\caption{Confusion matrix for Log Reg}
...
\begin{figure}[h]
	...
	\caption{Confusion matrix for Neural Nets}
	\label{pic:cm_NN}
\end{figure}
