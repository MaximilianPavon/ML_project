...
Apart from the simple stochastic gradient descent we tried also an optimiser from the family of quasi-Newton methods and the well known update technique Adam, which refers to the stochastic gradient-based optimiser proposed by Kingma, Diederik, and Jimmy Ba.
