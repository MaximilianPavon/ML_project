...
The support vector machines perform relatively bad, because it overfitted the data strongly and therefore did not learn enough in order to generalise well for unseen data.
