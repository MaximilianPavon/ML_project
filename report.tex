...
\begin{itemize}
\item \textcolor{red}{Discuss the relevance of the performance measures (accuracy and LogLoss) for imbalanced multiclass datasets.}
\item How the results relate to the literature.
\item \textcolor{green}{Suggestions for future research/improvement.}
\item \textcolor{green}{Did the study answer your questions?}
\end{itemize}
}
