...
Here we tried two differerent Naïve algorithms, Gaussian Naïve Bayes and Multinomial Naïve Bayes. The performance for both of them though wasn't acceptable as none beat the benchmark.
...
Multinomial Naïve Bayes was scaled normally, and didn't use any prior either.
