...
\title{\textbf{Performance comparison on music genre classification for Logistic Regression, Support Vector Machines, Naïve Bayes classifiers and Neural Networks} \\
